...
func TestNewRealVault(t *testing.T) {
	...
	model := New(scan.Files(), notes, graph.New(noteList, resources), roles, contract.KnowledgeScope(), policy, contract.JournalDir(), contract.ArticleLanguage(), contract.AuthoredDate())
