...
func TestRecoveryClassification(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "non instance", err: ErrNonInstance, code: http.StatusUnprocessableEntity, noDetail: true, wantSummary: wording.NonInstanceReason},
		{name: "outside knowledge scope", err: ErrOutsideKnowledgeScope, code: http.StatusUnprocessableEntity, noDetail: true, wantSummary: wording.OutsideKnowledgeScope},
		...
		{name: "hard linked", err: errors.Join(ErrHardLinked, errors.New("two names")), code: http.StatusUnprocessableEntity, wantDetail: "two names", wantSummary: wording.NoteHardLinked},
