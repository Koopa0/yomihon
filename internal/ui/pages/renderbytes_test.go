...
func recordedNoteView(t *testing.T, model *nav.Model, current string) NoteView {
	...
	return NoteView{
		...
		BasedOn: []snapshot.DeclaredSource{
			{Name: "Book notes", RelPath: "Book notes.md", WholeFile: true, Locations: []render.SourceLocation{{Label: "Methods", Fragment: "methods"}, {Label: "^quote-1", Fragment: "^quote-1"}}},
			{Name: "One place", RelPath: "One place.md", Locations: []render.SourceLocation{{Label: "Observation", Fragment: "observation"}}},
			{Name: "[[twin]]"},
		},
