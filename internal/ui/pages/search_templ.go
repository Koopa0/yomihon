...
type SearchView struct {
	...
	// Total is how many hits the query truly has. Results holds one page of
	// them, or — on a face with no strip under the rows — the bounded opening
	// stretch, and the count line says which of the two it is looking at.
	Total      int
	Diagnostic string

	// Pager is the way to the rest of a long answer, drawn under the rows. It
	// is empty on the palette, which floats over a page it does not own and has
	// nowhere to send a reader who follows a page number.
	Pager Pager
...
func Search(v SearchView, c layouts.Chrome) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/search.templ`, Line: 233, Col: 104}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/search.templ`, Line: 233, Col: 155}
			}
...
func SearchResults(v SearchView, lang wording.Lang) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if v.Diagnostic != "" {
			...
			templ_7745c5c3_Err = pager(v.Pager, lang).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		} else if v.Query != "" {
