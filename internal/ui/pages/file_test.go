...
func TestHumanSize(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "empty", n: 0, want: "0 位元組"},
		{name: "one byte is singular", n: 1, want: "1 位元組"},
		{name: "two bytes", n: 2, want: "2 位元組"},
		{name: "just under a kilobyte", n: 1023, want: "1,023 位元組"},
		{name: "a kilobyte", n: 1024, want: "1.0 KB（1,024 位元組）"},
		{name: "a megabyte", n: 1 << 20, want: "1.0 MB（1,048,576 位元組）"},
		{name: "a gigabyte", n: 1 << 30, want: "1.0 GB（1,073,741,824 位元組）"},
	}
