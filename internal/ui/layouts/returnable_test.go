...
// TestReturnableAddressRefusesANonGETTarget holds the address a control
// carries back to places a GET can revisit: a POST-rendered page names a
// target, not a page, so it falls back to Home.
