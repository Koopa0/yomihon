...
type: concept
---
[[Target#Real Section]] resolves whole.
[[Target#Missing Section]] names a section that is not there.
[[Target#^blk1]] reaches the marked line.
[[Target#^ghost]] names a block nobody marked.
[[#Missing Local]] stays a same-file jump and is never judged.
[[Target#gc 與 heap]] folds case the way the page's ids fold.
